...
public class VitalDXObjects {

// public WebDriver driver=null;
// public VitalDXObjects (WebDriver driver)
// 	{
// 		this.driver = driver;
...
ThreadLocal<WebDriver> driver;
	 	public VitalDXObjects (ThreadLocal<WebDriver> driver)
	{
		this.driver = driver;
...
@FindBy(xpath="//select[@id='ddlCaseType']")public WebElement CaseDropdown;

@FindBy(xpath="//iframe[@id='workAreaFrame']	")public WebElement ChildIframe;
...
@FindBy(xpath="//input[@id='txtNewLastName']	")public WebElement LastNameTextfield;
...
@FindBy(xpath="//table/tbody/tr[1]/td[2]/div/iframe[@id='workAreaFrame']")public WebElement ChildFrame;
...
@FindBy(xpath="(//table/tbody/tr[1]/td[5]/button[@class='ProcessingCompleteRuleEngine'])[1]")public WebElement FinishProcess;

@FindBy(xpath="//textarea[@id='txtMicroNotes_1']")public WebElement Micronote;

@FindBy(xpath="(//div/ul/li[@class='TabbedPanelsTab tooltip ui-state-default ui-corner-top'])[2]")public WebElement TestStrains;

@FindBy(xpath="//img[@id='newQuickSearchImg']")public WebElement SearchIcon;
//pomStart
