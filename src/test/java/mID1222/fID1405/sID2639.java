...
public class sID2639 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        @Parameters({"iterations"})
          ...
          try
          {
              ...
              ranstr=javamethod.generateRandomAlphabetic(5);
      ...
      Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        @Parameters({"iterations"})
          ...
          {
              String varMethodName=Thread.currentThread().getStackTrace()[1].getMethodName();
              actions.PrintVariable(ranstr, "ranstr", varMethodName);
      ...
      Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        @Parameters({"iterations"})
          ...
          {
              String varMethodName=Thread.currentThread().getStackTrace()[1].getMethodName();
              actions.setData("/Excel/String.xlsx","Sheet1",2,2,ranstr);
      ...
      Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        @Parameters({"iterations"})
          ...
          {
              String varMethodName=Thread.currentThread().getStackTrace()[1].getMethodName();
              var2=actions.getData("./Excel/String.xlsx","Sheet1",2,2);
      ...
      Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        @Parameters({"iterations"})
          ...
          {
              String varMethodName=Thread.currentThread().getStackTrace()[1].getMethodName();
              result=javamethod.Concat("FirstName_",var2);
      ...
      Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        @Parameters({"iterations"})
          ...
          {
              String varMethodName=Thread.currentThread().getStackTrace()[1].getMethodName();
              actions.setData("/Excel/String.xlsx","Sheet1",3,3,result);
      ...
      Reporter.log(actions.CaptureScreenShotAtEachStep(path,methodName,screenshotOption));
        ...
        @Parameters({"iterations"})
          ...
          {
              String varMethodName=Thread.currentThread().getStackTrace()[1].getMethodName();
              actions.PrintVariable(result, "result", varMethodName);
